//
//  GenreSelectedViewController.swift
//  Flicker
//
...
class GenreSelectedViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    func loadDataFromNetwork() {
        ...
        let url = NSURL(string: "http://api.themoviedb.org/3/genre/\(id)/movies?api_key=\(apiKey)")
