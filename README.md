...
- [x] Added in collectionview of related movies within each detail page
- [x] Created custom segue from tableview to detail page
- [x] Implemented switching from tableview to collectionview by clicking same tabbar by using custom segue
- [x] Infinite scrolling of tableview/collectionview
...
- [x] API Client extended to get related movies
- [x] API Client extended to get trailer of mvie
